...
exports.mapping = {
	...
	["tick"] = {
		description = "Returns the current tick from Roblox Luau.",
		requiredEntries = 0,
		params = {},
		returns = "number",
	},
	...
	["crop"] = {
		description = "Crops an specific amount of characters in a string. (third value is optional, by default is the same same second value)",
		requiredEntries = 2,
		params = {"string", "number", "number"},
		returns = "string",
	},
	["first"] = {
		description = "Returns a amount of characters in the beginning of the string.",
		requiredEntries = 2,
		params = {"string", "number"},
		returns = "string",
	},
	["last"] = {
		description = "Returns a amount of characters in the ending of the string.",
		requiredEntries = 2,
		params = {"string", "number"},
		returns = "string",
	},
	...
	["sort"] = {
		description = "Sorts a character in a string or a random value in a list.",
		requiredEntries = 1,
		params = {"list/string"},
		returns = "any",
	},
	...
	["clamp"] = {
		description = "Returns a number between a min and a max value, depending on the alpha number (third value)",
		requiredEntries = 3,
	...
	["cosh"] = {
		description = "Returns the hyperbolic cosine of the value.",
		requiredEntries = 1,
		params = {"number"},
		returns = "number",
	},
	["sinh"] = {
		description = "Returns the hyperbolic sine of the value.",
		requiredEntries = 1,
		params = {"number"},
		returns = "number",
	},
